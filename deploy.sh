...
az rest \
  --method post \
  --url "https://management.azure.com/subscriptions/$(az account show --query id -o tsv)/resourceGroups/${RESOURCE_GROUP}/providers/Microsoft.DatabaseWatcher/watchers/${WATCHER_NAME}/start?api-version=2025-01-02" \
